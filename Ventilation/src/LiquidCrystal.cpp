...
void delayMicroseconds(unsigned int us)
{
	...
	uint64_t x = (uint64_t)Chip_Clock_GetSystemClockRate()/1000000 ;
	uint64_t z = us*x;
...
{
	LiquidCrystal::print(std::string(s));
}
